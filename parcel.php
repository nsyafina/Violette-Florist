...
<body>
  ...
  <div class="container" style="margin-top: 35px;">
    <div class="card bg-light border-secondary card-carousel text-white">
      <img src="img/produk/parcel/bg-title.jpg" class="card-img cc-img" alt="...">
      <div class="card-img-overlay">
        <h5 class="card-title cc-title cc-box"><strong>Hampers</strong></h5>
      </div>
    </div>
  </div>
  <!-------------------------------------------------------------- Card-Carousel End -------------------------------------------------------------->
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/hampers/goldenelegance.html"><img src="img/produk/parcel/goldenelegance.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Golden Elegance</strong></h5>
          <p align="center">Rp735.000,-</p>
          <a href="innerpage-product/hampers/goldenelegance.html" class="btn tombol-produk">Order Now</a>
    ...
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/hampers/growinggarden.html"><img src="img/produk/parcel/growinggarden.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Growing Garden</strong></h5>
          <p align="center">Rp750.000,-</p>
          <a href="innerpage-product/hampers/growinggarden.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/hampers/pinkishelegance.html"><img src="img/produk/parcel/pinkishelegance.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Pinkish Elegance</strong></h5>
          <p align="center">Rp470.000,-</p>
          <a href="innerpage-product/hampers/pinkishelegance.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/hampers/premiumfemme.html"><img src="img/produk/parcel/premiumfemme.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Premium Femme</strong></h5>
          <p align="center">Rp975.000,-</p>
          <a href="innerpage-product/hampers/premiumfemme.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/hampers/classicgarden.html"><img src="img/produk/parcel/classicgarden.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Classic Garden</strong></h5>
            <p align="center">Rp700.000,-</p>
            <a href="innerpage-product/hampers/classicgarden.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/hampers/rosetteromance.html"><img src="img/produk/parcel/rosetteromance.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Rosette Romance</strong></h5>
            <p align="center">Rp630.000,-</p>
            <a href="innerpage-product/hampers/rosetteromance.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/hampers/blackisland.html"><img src="img/produk/parcel/blackisland.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Black Island</strong></h5>
            <p align="center">Rp635.000,-</p>
            <a href="innerpage-product/hampers/blackisland.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/hampers/whiteisland.html"><img src="img/produk/parcel/whiteisland.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>White Island</strong></h5>
            <p align="center">Rp500.000,-</p>
            <a href="innerpage-product/hampers/whiteisland.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
