...
<body>
  ...
  <div class="container" style="margin-top: 35px;">
    <div class="card bg-light border-secondary card-carousel text-white">
      <img src="img/produk/mix-bouquets/wllpp-title.jpg" class="card-img cc-img" alt="...">
      <div class="card-img-overlay">
        <h5 class="card-title cc-title cc-box"><strong>Mix Bouquets</strong></h5>
      </div>
    </div>
  </div>
  <!-------------------------------------------------------------- Card-Carousel End -------------------------------------------------------------->
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/mixbuket/latteinlove.html"><img src="img/produk/mix-bouquets/mixbuket-latteinlove1.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Latte In Love</strong></h5>
          <p align="center">Rp550.000,-</p>
          <a href="innerpage-product/mixbuket/latteinlove.html" class="btn tombol-produk">Order Now</a>
    ...
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/mixbuket/sweetpinkblossom.html"><img src="img/produk/mix-bouquets/mixbuket-sweetpinkblossom.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Sweet Pink Blossom</strong></h5>
          <p align="center">Rp510.000,-</p>
          <a href="innerpage-product/mixbuket/sweetpinkblossom.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/mixbuket/beautifullovesong.html"><img src="img/produk/mix-bouquets/mixbuket-beautifullovesong.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Beautiful Love Song</strong></h5>
          <p align="center">Rp505.000,-</p>
          <a href="innerpage-product/mixbuket/beautifullovesong.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/mixbuket/romanticred.html"><img src="img/produk/mix-bouquets/mixbuket-romanticred.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Romantic Red</strong></h5>
          <p align="center">Rp558.000,-</p>
          <a href="innerpage-product/mixbuket/romanticred.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/mixbuket/lovelypurple.html"><img src="img/produk/mix-bouquets/mixbuket-lovelypurple.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Lovely Purple</strong></h5>
            <p align="center">Rp470.000,-</p>
            <a href="innerpage-product/mixbuket/lovelypurple.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/mixbuket/wonderfullgarden.html"><img src="img/produk/mix-bouquets/mixbuket-wonderfullgarden.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Wonderfull Garden</strong></h5>
            <p align="center">Rp450.000,-</p>
            <a href="innerpage-product/mixbuket/wonderfullgarden.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/mixbuket/sweetsunshine.html"><img src="img/produk/mix-bouquets/mixbuket-sweetsunshine.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Sweet Sunshine</strong></h5>
            <p align="center">Rp555.000,-</p>
            <a href="innerpage-product/mixbuket/sweetsunshine.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/mixbuket/caramelblossom.html"><img src="img/produk/mix-bouquets/mixbuket-caramelblossom.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Caramel Blossom</strong></h5>
            <p align="center">Rp490.000,-</p>
            <a href="innerpage-product/mixbuket/caramelblossom.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
