...
<body>
  ...
  <div class="container" style="margin-top: 35px;">
    <div class="card bg-light border-secondary card-carousel text-white">
      <img src="img/produk/floralbox/wllpp-title.jpg" class="card-img cc-img" alt="...">
      <div class="card-img-overlay">
        <h5 class="card-title cc-title cc-box"><strong>Floral Box</strong></h5>
      </div>
    </div>
  </div>
  <!-------------------------------------------------------------- Card-Carousel End -------------------------------------------------------------->
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/box/andeli.html"><img src="img/produk/floralbox/box-andeli.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Andeli Box</strong></h5>
          <p align="center">Rp795.000,-</p>
          <a href="innerpage-product/box/andeli.html" class="btn tombol-produk">Order Now</a>
    ...
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/box/pinkrose.html"><img src="img/produk/floralbox/box-pinkrose.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Pink Rose Box</strong></h5>
          <p align="center">Rp635.000,-</p>
          <a href="innerpage-product/box/pinkrose.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/box/bluerose.html"><img src="img/produk/floralbox/box-bluerose.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Blue Rose Box</strong></h5>
          <p align="center">Rp740.000,-</p>
          <a href="innerpage-product/box/bluerose.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/box/whiterose.html"><img src="img/produk/floralbox/box-whiterose.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>White Rose Box</strong></h5>
          <p align="center">Rp457.000,-</p>
          <a href="innerpage-product/box/whiterose.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/box/tulip.html"><img src="img/produk/floralbox/box-tulip.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Tulip Box</strong></h5>
            <p align="center">Rp560.000,-</p>
            <a href="innerpage-product/box/tulip.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/box/bear.html"><img src="img/produk/floralbox/box-bear.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Box With Bear</strong></h5>
            <p align="center">Rp500.000,-</p>
            <a href="innerpage-product/box/bear.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
