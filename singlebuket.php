...
<body>
  ...
  <div class="container" style="margin-top: 35px;">
    <div class="card bg-light border-secondary card-carousel text-white">
      <img src="img/produk/singlebuket/wpp-judul.jpg" class="card-img cc-img" alt="...">
      <div class="card-img-overlay">
        <h5 class="card-title cc-title cc-box"><strong>Single Bouquets</strong></h5>
      </div>
    </div>
  </div>
  <!-------------------------------------------------------------- Card-Carousel End -------------------------------------------------------------->
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/sbuket/carnation.html"><img src="img/produk/singlebuket/singlebuket-carnation.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Carnation Bouquet</strong></h5>
          <p align="center">Rp110.000,-</p>
          <a href="innerpage-product/sbuket/carnation.html" class="btn tombol-produk">Order Now</a>
    ...
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/sbuket/lavender.html"><img src="img/produk/singlebuket/singlebuket-lavender.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Lavender Bouquet</strong></h5>
          <p align="center">Rp245.000,-</p>
          <a href="innerpage-product/sbuket/lavender.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/sbuket/gerbera.html"><img src="img/produk/singlebuket/singlebuket-gerbera.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Gerbera Bouquet</strong></h5>
          <p align="center">Rp105.000,-</p>
          <a href="innerpage-product/sbuket/gerbera.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/sbuket/sunflo.html"><img src="img/produk/singlebuket/singlebuket-sunflo.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Sunflower Bouquet</strong></h5>
          <p align="center">Rp245.000,-</p>
          <a href="innerpage-product/sbuket/sunflo.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/sbuket/tulip.html"><img src="img/produk/singlebuket/singlebuket-tulip.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Tulip Bouquet</strong></h5>
            <p align="center">Rp310.000,-</p>
            <a href="innerpage-product/sbuket/tulip.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/sbuket/mawar.html"><img src="img/produk/singlebuket/singlebuket-mawar.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Rose Bouquet</strong></h5>
            <p align="center">Rp220.000,-</p>
            <a href="innerpage-product/sbuket/mawar.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
