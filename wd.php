...
<body>
  ...
  <!-------------------------------------------------------------- Topbanner -------------------------------------------------------------->
    ...
    <img src="img/seasonal/topbanner/wd4.jpg" style="width: 100%;">
  ...
  <div class="container">
    <div class="sidebanner">
      <div class="img-thumbnail border-secondary body-sidebanner">
        <img src="img/seasonal/sidebanner/wd.jpg" class="img-sidebanner">
      </div>
    </div>
  </div>
  <!------------------------------------------------------------ Sidebanner End ----------------------------------------------------------->
  ...
  <div class="container">
    <div class="card border-secondary judulsf">
        <div class="card-body">
          <h3 align="center"><strong>Wedding Occasion</strong></h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/wd/passionatelove.html"><img src="img/seasonal/wd/passionatelove.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Passionate Love</strong></h5>
          <p align="center">Rp395.000,-</p>
          <a href="innerpage-seasonal/wd/passionatelove.html" class="btn tombol-produk">Order Now</a>
    ...
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/wd/purelove.html"><img src="img/seasonal/wd/purelove.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Pure Love</strong></h5>
          <p align="center">Rp450.000,-</p>
          <a href="innerpage-seasonal/wd/purelove.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/wd/perfectionoflove.html"><img src="img/seasonal/wd/perfectionoflove.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Perfection Of Love</strong></h5>
          <p align="center">Rp425.000,-</p>
          <a href="innerpage-seasonal/wd/perfectionoflove.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-3 g-4 space">
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-seasonal/wd/unconditionallove.html"><img src="img/seasonal/wd/unconditionallove.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Unconditional Love</strong></h5>
            <p align="center">Rp435.000,-</p>
            <a href="innerpage-seasonal/wd/unconditionallove.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-seasonal/wd/rosylove.html"><img src="img/seasonal/wd/rosylove.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Rosy Love</strong></h5>
            <p align="center">Rp360.000,-</p>
            <a href="innerpage-seasonal/wd/rosylove.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-seasonal/wd/endlesslove.html"><img src="img/seasonal/wd/endlesslove.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Endless Love</strong></h5>
            <p align="center">Rp370.000,-</p>
            <a href="innerpage-seasonal/wd/endlesslove.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
