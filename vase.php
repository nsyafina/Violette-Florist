...
<body>
  ...
  <div class="container" style="margin-top: 35px;">
    <div class="card bg-light border-secondary card-carousel text-white">
      <img src="img/produk/vase/bg-title.jpg" class="card-img cc-img" alt="...">
      <div class="card-img-overlay">
        <h5 class="card-title cc-title cc-box"><strong>Vases</strong></h5>
      </div>
    </div>
  </div>
  <!-------------------------------------------------------------- Card-Carousel End -------------------------------------------------------------->
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/vase/cat.html"><img src="img/produk/vase/vase-cat.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Cat Vase</strong></h5>
          <p align="center">Rp550.000,-</p>
          <a href="innerpage-product/vase/cat.html" class="btn tombol-produk">Order Now</a>
    ...
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/vase/floral.html"><img src="img/produk/vase/vase-floral.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Flower Vase</strong></h5>
          <p align="center">Rp705.000,-</p>
          <a href="innerpage-product/vase/floral.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/vase/cutie.html"><img src="img/produk/vase/vase-cutie.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Cutie Vase</strong></h5>
          <p align="center">Rp430.000,-</p>
          <a href="innerpage-product/vase/cutie.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-product/vase/wave.html"><img src="img/produk/vase/vase-wave.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Wave Vase</strong></h5>
          <p align="center">Rp688.000,-</p>
          <a href="innerpage-product/vase/wave.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-4 g-4 mt-3">
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/vase/jus.html"><img src="img/produk/vase/vase-jus.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Orange Juice Vase</strong></h5>
            <p align="center">Rp745.000,-</p>
            <a href="innerpage-product/vase/jus.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/vase/spiral.html"><img src="img/produk/vase/vase-spiral.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Spiral Vase</strong></h5>
            <p align="center">Rp545.000,-</p>
            <a href="innerpage-product/vase/spiral.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/vase/candy.html"><img src="img/produk/vase/vase-candy.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Candy Vase</strong></h5>
            <p align="center">Rp495.000,-</p>
            <a href="innerpage-product/vase/candy.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-product/vase/bag.html"><img src="img/produk/vase/vase-bag.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Handbag Vase</strong></h5>
            <p align="center">Rp566.000,-</p>
            <a href="innerpage-product/vase/bag.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
