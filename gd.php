...
<body>
  ...
  <!---------------------------------------------------------------- Topbanner ---------------------------------------------------------------->
    ...
    <img src="img/seasonal/topbanner/gd2.jpg" style="width: 100%;">
  ...
  <div class="container">
    <div class="sidebanner">
      <div class="img-thumbnail border-secondary body-sidebanner">
        <img src="img/seasonal/sidebanner/grd.jpg" class="img-sidebanner">
      </div>
    </div>
  </div>
  <!---------------------------------------------------------------- Sidebanner End --------------------------------------------------------------->
  ...
  <div class="container">
    <div class="card border-secondary judulsf">
        <div class="card-body">
          <h3 align="center"><strong>Graduation Occasion</strong></h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/gd/futurefabulous.html"><img src="img/seasonal/gd/futurefabulous1.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Future Fabulous</strong></h5>
          <p align="center">Rp320.000,-</p>
          <a href="innerpage-seasonal/gd/futurefabulous.html" class="btn tombol-produk">Order Now</a>
    ...
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/gd/brightfuture.html"><img src="img/seasonal/gd/brightfuture1.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Bright Future</strong></h5>
          <p align="center">Rp315.000,-</p>
          <a href="innerpage-seasonal/gd/brightfuture.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/gd/seedsofsuccess.html"><img src="img/seasonal/gd/seedsofsuccess.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Seeds of Success</strong></h5>
          <p align="center">Rp285.000,-</p>
          <a href="innerpage-seasonal/gd/seedsofsuccess.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-3 g-4 space">
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-seasonal/gd/qualityseeds.html"><img src="img/seasonal/gd/qualityseeds.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Quality Seeds</strong></h5>
            <p align="center">Rp300.000,-</p>
            <a href="innerpage-seasonal/gd/qualityseeds.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-seasonal/gd/diamondsplash.html"><img src="img/seasonal/gd/diamondsplash.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Diamond Splash</strong></h5>
            <p align="center">Rp480.000,-</p>
            <a href="innerpage-seasonal/gd/diamondsplash.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-seasonal/gd/growingcareer.html"><img src="img/seasonal/gd/growingcareer.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Growing Career</strong></h5>
            <p align="center">Rp540.000,-</p>
            <a href="innerpage-seasonal/gd/growingcareer.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
