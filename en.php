...
<body>
  ...
  <!---------------------------------------------------------------- Topbanner ---------------------------------------------------------------->
    ...
    <img src="img/seasonal/topbanner/en2.jpg" style="width: 100%;">
  ...
  <div class="container">
    <div class="sidebanner">
      <div class="img-thumbnail border-secondary body-sidebanner">
        <img src="img/seasonal/sidebanner/en.jpg" class="img-sidebanner">
      </div>
    </div>
  </div>
  <!---------------------------------------------------------------- Sidebanner End --------------------------------------------------------------->
  ...
  <div class="container">
    <div class="card border-secondary judulsf">
        <div class="card-body">
          <h3 align="center"><strong>Engagement Occasion</strong></h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/en/redvelvet.html"><img src="img/seasonal/en/redvelvet.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Red Velvet</strong></h5>
          <p align="center">Rp500.000,-</p>
          <a href="innerpage-seasonal/en/redvelvet.html" class="btn tombol-produk">Order Now</a>
    ...
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/en/luxuryblossom.html"><img src="img/seasonal/en/luxuryblossom.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Luxury Blossom</strong></h5>
          <p align="center">Rp610.000,-</p>
          <a href="innerpage-seasonal/en/luxuryblossom.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="img-thumbnail border-secondary body-produk">
        <a href="innerpage-seasonal/en/beautysymphony.html"><img src="img/seasonal/en/beautysymphony.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
        <div class="card-body">
          <h5 class="card-title-produk"><strong>Beauty Symphony</strong></h5>
          <p align="center">Rp760.000,-</p>
          <a href="innerpage-seasonal/en/beautysymphony.html" class="btn tombol-produk">Order Now</a>
          <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-3 g-4 space">
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-seasonal/en/sweetestlove.html"><img src="img/seasonal/en/sweetestlove.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Sweetest Love</strong></h5>
            <p align="center">Rp605.000,-</p>
            <a href="innerpage-seasonal/en/sweetestlove.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="img-thumbnail border-secondary body-produk">
          <a href="innerpage-seasonal/en/gorgeousred.html"><img src="img/seasonal/en/gorgeousred.jpg" class="img-produk" style="border-radius: 30px;" alt="..."></a>
          <div class="card-body">
            <h5 class="card-title-produk"><strong>Gorgeous Red</strong></h5>
            <p align="center">Rp410.000,-</p>
            <a href="innerpage-seasonal/en/gorgeousred.html" class="btn tombol-produk">Order Now</a>
            <a href="#"><i class="fa-solid fa-cart-plus icon-produk"></i></a>
          </div>
        </div>
      </div>
